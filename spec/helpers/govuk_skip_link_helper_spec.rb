...
RSpec.describe(DsfrSkipLinkHelper, type: 'helper') do
  ...
  describe '#dsfr_skip_link' do
    ...
    context 'when href provided' do
      subject { dsfr_skip_link(href: custom_href) }
    ...
    describe 'extra classes' do
      context 'when supplied with extra classes as a string' do
        ...
        subject { dsfr_skip_link(classes: custom_classes) }
    ...
    describe 'custom html attributes' do
      ...
      subject { dsfr_skip_link(**custom_attributes) }
    ...
    describe 'custom HTML' do
      ...
      subject { dsfr_skip_link { tag.span(custom_text, class: custom_class) } }
